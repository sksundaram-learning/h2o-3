...
class H2OFrame(object):
    ...
    def merge(self, other, all_x=False, all_y=False, by_x=None, by_y=None, method="auto"):
        ...
        Only one can be True or none is True.  The default merge method is radix and we support hash merge as well.
        If there are duplicated rows in your rite frame, they will not be included if you use the hash method.
        Since it is rare to perform merge with duplicated rows an the right frames, this should be okay.  On the
        other hand, radix method will return the correct merge regardless of duplicated rows in the right frame.
        ...
        :param method: string representing the merge method, one of auto, radix (default) or hash.
